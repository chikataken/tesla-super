"""
Local OCR pre-filter (Tesseract). Finds which delivery photos contain the VIN so
only those go to the Claude API.

Requires the Tesseract binary (`brew install tesseract`) and `pytesseract`.
"""
